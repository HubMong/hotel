<template>
  <div class="searchbar-wrap" :style="stickyStyle">
    <div class="searchbar">
      ...
      <!-- 검색 버튼 (동작: 날짜만 URL 반영) -->
      <button class="cell btn" @click="applyQueryOnly">검색하기</button>
    </div>
...
// sticky style
const stickyStyle = computed(() => ({ position: 'sticky', top: `${props.top}px`, zIndex: 2000, background:'#fff' }))
...
/* 상단 고정 바 */
.searchbar-wrap{ position: sticky; top: 0; z-index: 2000; padding: 10px 14px; background:#fff; border-bottom:1px solid #eee; }
