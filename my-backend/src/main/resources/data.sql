...
(2,9,'2','2','PERCENTAGE',22,0,'2025-09-11 05:10:00','2025-10-03 14:10:00',1),
(7,9,'22','22','PERCENTAGE',22,2222,'2025-09-03 15:50:00','2025-09-10 15:50:00',1);
...
--
-- Table structure for table `website_inquiry`
--

DROP TABLE IF EXISTS `website_inquiry`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `website_inquiry` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT, -- Primary Key, 자동 증가
  `category` VARCHAR(255) NOT NULL,        -- NOT NULL로 설정 (이미지에 기본값이 없으나, 일반적으로 카테고리는 필수)
  `title` VARCHAR(255) NOT NULL,           -- NOT NULL로 설정 (이미지에 기본값이 없으나, 일반적으로 제목은 필수)
  `message` TEXT NOT NULL,                 -- 문의 내용, TEXT 타입, NOT NULL로 설정
  `user_id` BIGINT(20) NULL,               -- 문의를 등록한 사용자 ID (NULL 허용)
  `status` VARCHAR(255) NOT NULL DEFAULT 'PENDING', -- 문의 상태, 기본값 'PENDING'
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, -- 생성 시간, TIMESTAMP 타입, 기본값 CURRENT_TIMESTAMP (NOT NULL)
  `inquiry_email` VARCHAR(100) NOT NULL,   -- 문의자 이메일 (NOT NULL로 설정, 연락을 위해 필요하다고 가정)
  `inquiry_name` VARCHAR(100) NULL,        -- 문의자 이름 (NULL 허용)
  `replied_at` DATETIME(6) NULL,           -- 답변 시간 (NULL 허용, DATETIME(6)는 밀리초까지 저장)
  `reply_content` TEXT NULL,               -- 답변 내용 (NULL 허용)
  `replied_by` BIGINT(20) NULL,            -- 답변한 관리자 ID (NULL 허용)
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `website_inquiry` WRITE;
/*!40000 ALTER TABLE `website_inquiry` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `website_inquiry` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
CREATE TABLE `payment` (
  ...
  `status` enum('CANCELLED','FAILED','PAID','PENDING','REFUNDED') NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `refunded_at` timestamp NULL DEFAULT NULL,
  `receipt_url` varchar(512) DEFAULT NULL,
  `settlement_status` enum('COMPLETED','FAILED','ON_HOLD','SCHEDULED') DEFAULT NULL,
...
(1,1,'CREDIT_CARD',360000,390000,30000,0,'PAID','2024-01-10 01:35:00',NULL,'https://receipt.example.com/TXN-2024-0001',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(2,2,'KAKAO_PAY',840000,882000,42000,0,'PAID','2024-02-15 05:25:00',NULL,'https://receipt.example.com/TXN-2024-0002',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(3,3,'NAVER_PAY',900000,945000,45000,0,'PAID','2024-03-05 00:20:00',NULL,'https://receipt.example.com/TXN-2024-0003',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(4,4,'CREDIT_CARD',1520000,1596000,76000,0,'PAID','2024-12-20 07:50:00',NULL,'https://receipt.example.com/TXN-2024-0004',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(5,5,'TOSS_PAY',390000,409500,19500,0,'PAID','2024-12-27 02:35:00',NULL,'https://receipt.example.com/TXN-2024-0005',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(6,6,'CREDIT_CARD',1950000,2047500,97500,0,'REFUNDED','2024-03-27 23:25:00','2024-04-02 06:30:00','https://receipt.example.com/TXN-2024-0006',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(7,7,'BANK_TRANSFER',180000,189000,9000,0,'REFUNDED','2024-05-01 04:15:00','2024-05-10 00:45:00','https://receipt.example.com/TXN-2024-0007',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(8,8,'CREDIT_CARD',840000,882000,42000,0,'PAID','2024-12-28 01:05:00',NULL,'https://receipt.example.com/TXN-2024-0008',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(9,9,'KAKAO_PAY',900000,945000,45000,0,'REFUNDED','2024-12-28 06:35:00','2025-09-26 09:05:49','https://receipt.example.com/TXN-2024-0009',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(10,10,'PAYPAL',1520000,1596000,76000,0,'REFUNDED','2024-12-28 11:20:00','2025-09-26 04:59:56','https://receipt.example.com/TXN-2024-0010',NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
(1,1,1,'TXN-2024-0001',2,0,'2024-01-15 06:00:00','2024-01-17 02:00:00','2024-01-10 01:30:00','COMPLETED',NULL,0),
(2,2,4,'TXN-2024-0002',2,1,'2024-02-20 07:00:00','2024-02-23 02:00:00','2024-02-15 05:20:00','COMPLETED',NULL,0),
(3,3,2,'TXN-2024-0003',3,1,'2024-03-10 06:00:00','2024-03-12 02:00:00','2024-03-05 00:15:00','COMPLETED',NULL,0),
(4,4,5,'TXN-2024-0004',4,2,'2024-12-25 07:00:00','2024-12-27 02:00:00','2024-12-20 07:45:00','COMPLETED','2024-12-24 14:59:59',0),
(5,5,3,'TXN-2024-0005',1,0,'2024-12-30 06:00:00','2025-01-02 02:00:00','2024-12-27 02:30:00','CANCELLED','2024-12-29 14:59:59',0),
(6,1,6,'TXN-2024-0006',2,0,'2024-04-05 07:00:00','2024-04-08 02:00:00','2024-03-27 23:20:00','CANCELLED',NULL,0),
(7,2,1,'TXN-2024-0007',1,0,'2024-05-12 06:00:00','2024-05-14 02:00:00','2024-05-01 04:10:00','CANCELLED',NULL,0),
(8,3,4,'TXN-2024-0008',3,0,'2025-01-15 07:00:00','2025-01-18 02:00:00','2024-12-28 01:00:00','CANCELLED','2025-01-14 14:59:59',0),
(9,4,2,'TXN-2024-0009',2,0,'2025-02-10 06:00:00','2025-02-12 02:00:00','2024-12-28 06:30:00','CANCELLED','2025-02-09 14:59:59',0),
(10,5,5,'TXN-2024-0010',4,1,'2025-03-20 07:00:00','2025-03-24 02:00:00','2024-12-28 11:15:00','CANCELLED','2025-03-19 14:59:59',0);
...
(1,1,'디럭스 더블룸','더블',1,2,'15:00:00','11:00:00',0x01,1,'더블베드','체크인 1일 전까지 무료 취소',0x01,0x01,200000,'CARD',180000,0x00,0x00,'시티뷰',0x01,'AVAILABLE',0,NULL),
(2,1,'이그제큐티브 스위트','스위트',2,4,'15:00:00','11:00:00',0x01,2,'킹베드 + 소파베드','체크인 2일 전까지 무료 취소',0x01,0x01,500000,'CARD',450000,0x00,0x00,'한강뷰',0x01,'AVAILABLE',0,NULL),
(3,1,'스탠다드 트윈룸','트윈',1,2,'15:00:00','11:00:00',0x01,1,'트윈베드','체크인 1일 전까지 무료 취소',0x01,0x01,150000,'CARD',130000,0x00,0x00,'시티뷰',0x01,'AVAILABLE',0,NULL),
(4,2,'오션뷰 디럭스','더블',2,3,'16:00:00','11:00:00',0x01,1,'더블베드','체크인 3일 전까지 무료 취소',0x01,0x01,300000,'CARD',280000,0x00,0x00,'오션뷰',0x01,'AVAILABLE',0,NULL),
(5,2,'패밀리 룸','패밀리',6,6,'16:00:00','11:00:00',0x01,2,'킹베드 + 번크베드',NULL,0x01,0x01,400000,NULL,380000,0x00,0x00,NULL,0x01,'AVAILABLE',0,NULL),
(6,2,'프리미엄 스위트','스위트',4,4,'16:00:00','11:00:00',0x01,2,'킹베드 + 거실',NULL,0x01,0x01,700000,NULL,650000,0x00,0x00,NULL,0x01,'available',0,NULL),
(7,2,'객실','테스트',1,1,'15:00:00','11:00:00',0x00,0,'침대',NULL,0x00,0x00,110000,NULL,100000,0x00,0x00,NULL,0x00,'available',0,NULL),
(8,2,'객실2','테스트',1,1,'15:00:00','11:00:00',0x00,0,'침대',NULL,0x00,0x00,200000,NULL,1000000,0x00,0x00,NULL,0x00,'available',0,NULL),
(10,2,'22','22',1,1,'15:00:00','11:00:00',0x00,0,'22',NULL,0x00,0x00,22222,NULL,2222,0x00,0x00,NULL,0x00,'available',1,NULL);
...
(1,1,'https://images.example.com/hotel1-room1-cover.jpg',0,1,'디럭스 더블룸 전경','그랜드 서울 호텔 디럭스 더블룸'),
(2,1,'https://images.example.com/hotel1-room1-bathroom.jpg',1,0,'디럭스 더블룸 욕실','그랜드 서울 호텔 디럭스 더블룸 욕실'),
(3,2,'https://images.example.com/hotel1-room2-cover.jpg',0,1,'이그제큐티브 스위트 전경','그랜드 서울 호텔 이그제큐티브 스위트'),
(4,2,'https://images.example.com/hotel1-room2-livingroom.jpg',1,0,'이그제큐티브 스위트 거실','그랜드 서울 호텔 이그제큐티브 스위트 거실'),
(5,3,'https://images.example.com/hotel1-room3-cover.jpg',0,1,'스탠다드 트윈룸 전경','그랜드 서울 호텔 스탠다드 트윈룸'),
(6,4,'https://images.example.com/hotel2-room1-cover.jpg',0,1,'오션뷰 디럭스 전경','제주 오션뷰 리조트 오션뷰 디럭스'),
(7,4,'https://images.example.com/hotel2-room1-oceanview.jpg',1,0,'오션뷰 디럭스 바다 전망','제주 오션뷰 리조트 오션뷰 디럭스 바다 전망'),
(8,5,'https://images.example.com/hotel2-room2-cover.jpg',0,1,'패밀리 룸 전경','제주 오션뷰 리조트 패밀리 룸'),
(9,5,'https://images.example.com/hotel2-room2-bunkbed.jpg',1,0,'패밀리 룸 이층침대','제주 오션뷰 리조트 패밀리 룸 이층침대'),
(10,6,'https://images.example.com/hotel2-room3-cover.jpg',0,1,'프리미엄 스위트 전경','제주 오션뷰 리조트 프리미엄 스위트'),
(11,6,'https://images.example.com/hotel2-room3-terrace.jpg',1,0,'프리미엄 스위트 프라이빗 테라스','제주 오션뷰 리조트 프리미엄 스위트 테라스');
...
(28,'2025-10-01 14:42:43.872328','2025-10-23','calendar-change',10,'maintenance'),
...
-- Dump completed on 2025-10-01 18:11:15