...
public class PaymentController {
    ...
    public ResponseEntity<?> add(@RequestBody Payment payload) {
        ...
        Payment p = Payment.builder()
                ...
                .paymentMethod(Optional.ofNullable(payload.getPaymentMethod()).orElse("TOSS"))
    ...
    public ResponseEntity<?> confirm(@RequestBody Map<String, Object> body) {
        ...
        if (rv.getStatus() == ReservationStatus.COMPLETED) {
        ...
        if (resp.getStatusCode() == HttpStatus.OK
            ...
            rv.setStatus(ReservationStatus.COMPLETED);
