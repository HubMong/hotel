...
import com.example.backend.dto.TossPaymentResponse;
...
public class PaymentController {
    ...
    @Transactional
    @PostMapping("/add")
    public ResponseEntity<Map<String, String>> add(@RequestBody Payment payment) {
        payment.setStatus("PENDING");
        repository.save(payment);

        return ResponseEntity.ok(Map.of("message", "결제 요청 추가됨"));
    }
